#[doc = "Reader of register USB1_LOOPBACK_HSFSCNT_TOG"]
pub type R = crate::R<u32, super::USB1_LOOPBACK_HSFSCNT_TOG>;
#[doc = "Writer for register USB1_LOOPBACK_HSFSCNT_TOG"]
pub type W = crate::W<u32, super::USB1_LOOPBACK_HSFSCNT_TOG>;
#[doc = "Register USB1_LOOPBACK_HSFSCNT_TOG `reset()`'s with value 0x0004_0010"]
impl crate::ResetValue for super::USB1_LOOPBACK_HSFSCNT_TOG {
    type Type = u32;
    #[inline(always)]

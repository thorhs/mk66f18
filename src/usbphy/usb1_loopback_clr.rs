#[doc = "Reader of register USB1_LOOPBACK_CLR"]
pub type R = crate::R<u32, super::USB1_LOOPBACK_CLR>;
#[doc = "Writer for register USB1_LOOPBACK_CLR"]
pub type W = crate::W<u32, super::USB1_LOOPBACK_CLR>;
#[doc = "Register USB1_LOOPBACK_CLR `reset()`'s with value 0x0055_0000"]
impl crate::ResetValue for super::USB1_LOOPBACK_CLR {
    type Type = u32;
    #[inline(always)]

#[doc = "Reader of register TRIM_OVERRIDE_EN"]
pub type R = crate::R<u32, super::TRIM_OVERRIDE_EN>;
#[doc = "Writer for register TRIM_OVERRIDE_EN"]
pub type W = crate::W<u32, super::TRIM_OVERRIDE_EN>;
#[doc = "Register TRIM_OVERRIDE_EN `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIM_OVERRIDE_EN {
    type Type = u32;
    #[inline(always)]

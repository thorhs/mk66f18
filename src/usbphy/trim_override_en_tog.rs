#[doc = "Reader of register TRIM_OVERRIDE_EN_TOG"]
pub type R = crate::R<u32, super::TRIM_OVERRIDE_EN_TOG>;
#[doc = "Writer for register TRIM_OVERRIDE_EN_TOG"]
pub type W = crate::W<u32, super::TRIM_OVERRIDE_EN_TOG>;
#[doc = "Register TRIM_OVERRIDE_EN_TOG `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIM_OVERRIDE_EN_TOG {
    type Type = u32;
    #[inline(always)]

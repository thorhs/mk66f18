#[doc = "Reader of register USB1_LOOPBACK_SET"]
pub type R = crate::R<u32, super::USB1_LOOPBACK_SET>;
#[doc = "Writer for register USB1_LOOPBACK_SET"]
pub type W = crate::W<u32, super::USB1_LOOPBACK_SET>;
#[doc = "Register USB1_LOOPBACK_SET `reset()`'s with value 0x0055_0000"]
impl crate::ResetValue for super::USB1_LOOPBACK_SET {
    type Type = u32;
    #[inline(always)]

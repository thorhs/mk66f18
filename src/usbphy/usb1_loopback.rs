#[doc = "Reader of register USB1_LOOPBACK"]
pub type R = crate::R<u32, super::USB1_LOOPBACK>;
#[doc = "Writer for register USB1_LOOPBACK"]
pub type W = crate::W<u32, super::USB1_LOOPBACK>;
#[doc = "Register USB1_LOOPBACK `reset()`'s with value 0x0055_0000"]
impl crate::ResetValue for super::USB1_LOOPBACK {
    type Type = u32;
    #[inline(always)]

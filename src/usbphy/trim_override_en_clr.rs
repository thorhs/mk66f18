#[doc = "Reader of register TRIM_OVERRIDE_EN_CLR"]
pub type R = crate::R<u32, super::TRIM_OVERRIDE_EN_CLR>;
#[doc = "Writer for register TRIM_OVERRIDE_EN_CLR"]
pub type W = crate::W<u32, super::TRIM_OVERRIDE_EN_CLR>;
#[doc = "Register TRIM_OVERRIDE_EN_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIM_OVERRIDE_EN_CLR {
    type Type = u32;
    #[inline(always)]

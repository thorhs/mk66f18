...
#[doc = "Possible values of the field `BUF4TO1I`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BUF4TO1IR {
    #[doc = "The corresponding buffer has no occurrence of successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
    _0,
...
impl BUF4TO1IR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            BUF4TO1IR::_0 => 0,
            BUF4TO1IR::_1 => 1,
            BUF4TO1IR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> BUF4TO1IR {
        match value {
            0 => BUF4TO1IR::_0,
            1 => BUF4TO1IR::_1,
            i => BUF4TO1IR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
    #[inline]
...
#[doc = "Values that can be written to the field `BUF4TO1I`"]
pub enum BUF4TO1IW {
    #[doc = "The corresponding buffer has no occurrence of successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
    _0,
    #[doc = "The corresponding buffer has successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
...
impl<'a> _BUF4TO1IW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: BUF4TO1IW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "The corresponding buffer has no occurrence of successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(BUF4TO1IW::_0)
    }
    #[doc = "The corresponding buffer has successfully completed transmission or reception when MCR\\[RFEN\\]=0."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(BUF4TO1IW::_1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl<'a> _BUF31TO8IW<'a> {
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(BUF31TO8IW::_0)
    }
    #[doc = "The corresponding buffer has successfully completed transmission or reception."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(BUF31TO8IW::_1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]

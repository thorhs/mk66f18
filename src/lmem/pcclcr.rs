#[doc = "Reader of register PCCLCR"]
pub type R = crate::R<u32, super::PCCLCR>;
#[doc = "Writer for register PCCLCR"]
pub type W = crate::W<u32, super::PCCLCR>;
#[doc = "Register PCCLCR `reset()`'s with value 0"]
impl crate::ResetValue for super::PCCLCR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 2:11 - Cache address"]
    #[inline(always)]
    pub fn cacheaddr(&self) -> CACHEADDR_R {
        CACHEADDR_R::new(((self.bits >> 2) & 0x03ff) as u16)
    }

#[doc = "Reader of register PCCCR"]
pub type R = crate::R<u32, super::PCCCR>;
#[doc = "Writer for register PCCCR"]
pub type W = crate::W<u32, super::PCCCR>;
#[doc = "Register PCCCR `reset()`'s with value 0"]
impl crate::ResetValue for super::PCCCR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `ENWRBUF`"]
pub type ENWRBUF_R = crate::R<bool, ENWRBUF_A>;
impl ENWRBUF_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `ENWRBUF`"]
pub struct ENWRBUF_W<'a> {
    w: &'a mut W,
}
impl<'a> ENWRBUF_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: ENWRBUF_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ENWRBUF_A::_0)
    }
    #[doc = "Write buffer enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ENWRBUF_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn enwrbuf(&self) -> ENWRBUF_R {
        ENWRBUF_R::new(((self.bits >> 1) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - Enable Write Buffer"]
    #[inline(always)]
    pub fn enwrbuf(&mut self) -> ENWRBUF_W {
        ENWRBUF_W { w: self }
    }
    #[doc = "Bit 2 - Forces all cacheable spaces to write through"]
    #[inline(always)]

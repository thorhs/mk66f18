#[doc = "Reader of register RGD%s_WORD0"]
pub type R = crate::R<u32, super::RGD_WORD0>;
#[doc = "Writer for register RGD%s_WORD0"]
pub type W = crate::W<u32, super::RGD_WORD0>;
#[doc = "Register RGD%s_WORD0 `reset()`'s with value 0"]
impl crate::ResetValue for super::RGD_WORD0 {
    type Type = u32;
    #[inline(always)]

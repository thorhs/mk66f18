#[doc = "Reader of register EPLISTADDR"]
pub type R = crate::R<u32, super::EPLISTADDR>;
#[doc = "Writer for register EPLISTADDR"]
pub type W = crate::W<u32, super::EPLISTADDR>;
#[doc = "Register EPLISTADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::EPLISTADDR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 11:31 - Endpoint list address"]
    #[inline(always)]

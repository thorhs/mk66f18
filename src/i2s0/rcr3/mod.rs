...
#[doc = "Possible values of the field `RCE`"]
...
impl RCER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            RCER::_0 => 0,
            RCER::_1 => 1,
            RCER::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> RCER {
        match value {
            0 => RCER::_0,
            1 => RCER::_1,
            i => RCER::_Reserved(i),
...
#[doc = "Values that can be written to the field `RCE`"]
pub enum RCEW {
    #[doc = "Receive data channel N is disabled."]
    _0,
    #[doc = "Receive data channel N is enabled."]
...
impl<'a> _RCEW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: RCEW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Receive data channel N is disabled."]
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(RCEW::_0)
    }
    #[doc = "Receive data channel N is enabled."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(RCEW::_1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {

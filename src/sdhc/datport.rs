#[doc = "Reader of register DATPORT"]
pub type R = crate::R<u32, super::DATPORT>;
#[doc = "Writer for register DATPORT"]
pub type W = crate::W<u32, super::DATPORT>;
#[doc = "Register DATPORT `reset()`'s with value 0"]
impl crate::ResetValue for super::DATPORT {
    type Type = u32;
    #[inline(always)]
